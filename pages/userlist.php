						...
						<table id="userhistory" class="table display  nowrap " width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td>
	<a href='../Prosses/exportuser.php?id=<?php echo $baris['id_user'];?>&profile=no' title="Download Report" class='btn btn-success'><i class='fa fa-download'></i></a>&nbsp;
	<a href='#edit_modal' class='btn btn-success' data-toggle='modal' title="Edit User" onclick='makebroadcast();' data-id="<?php echo $baris['id_user'];?>"><i class='fa fa-pencil-square-o'></i></a>&nbsp; 
	<a href='../Prosses/exportuser.php?id=<?php echo $baris['id_user'];?>&profile=delete ' title="Hapus User" class='btn btn-danger' onClick="return confirm('HAPUS AKUN & HISTORI: \n\nAnda yakin ingin menghapus Akun ini dan seluruh Histori nya? \nAkun dan Histori akan dihapus secara Permanen, \nAnda tidak dapat mengembalikan semuanya...!!!')"><i class='fa fa fa-trash-o'></i></a>&nbsp; 
	<a href='../Prosses/exportuser.php?id=<?php echo $baris['id_user'];?>&profile=clearhistori ' title="Hapus Histori" class='btn btn-danger' onClick="return confirm('HAPUS HISTORI : \n\nAnda yakin ingin menghapus seluruh Histori Akun ini? \nHistori akan dihapus secara Permanen, \nAnda tidak dapat mengembalikan semuanya...!!!')"><i class='fa fa fa-history'></i></a>&nbsp; 
	<a href='../Prosses/exportuser.php?id=<?php echo $baris['id_user'];?>&profile=resetvouchernya ' title="Reset Total Voucher" class='btn btn-danger' onClick="return confirm('RESET TOTAL VOUCHER : \n\nAnda yakin ingin menghapus seluruh Histori Akun ini? \nHistori akan dihapus secara Permanen, \nAnda tidak dapat mengembalikan semuanya...!!!')"><i class='fa fa fa-history'></i></a></td>
								</tr>
								<?php endforeach;
								?>

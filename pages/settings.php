 ...
 error_reporting(0);
	if (!isset($_SESSION["Mikbotamuser"])) {
		...
		if (isset($_POST['save'])) {
			...
			$viewid = getid($id);
			if (empty($viewid)) {
				$make = inbot($id, $token, $usernamebot, $namabot, $namarouter, $ipmik, $usernamemik, $passmik, $port, $dns, $owner, $idowner);
			} else {

				$dump = upbot($id, $token, $usernamebot, $namabot, $namarouter, $ipmik, $usernamemik, $passmik, $port, $dns, $owner, $idowner);
...
function testcon(){var _0x17A28=$("\x23\x69\x70").val();var _0x17A88=$("\x23\x75\x73\x65\x72\x6E\x61\x6D\x65").val();var _0x17A48=$("\x23\x70\x61\x73\x73\x77\x6F\x72\x64").val();var _0x17A68=$("\x23\x70\x6F\x72\x74\x61\x70\x69").val();$("\x23\x74\x65\x73\x74\x2D\x63\x6F\x6E\x6E\x65\x63\x74").html("");$.ajax({type:"\x50\x4F\x53\x54",url:"\x2E\x2E\x2F\x50\x72\x6F\x73\x73\x65\x73\x2F\x63\x6F\x6E\x6E\x74\x65\x73\x74\x2E\x70\x68\x70\x3F\x63\x6D\x64\x3D\x74\x65\x73\x74\x63\x6F\x6E",cache:false,data:{ip:_0x17A28,user:_0x17A88,pass:_0x17A48,portapi:_0x17A68},success:function(_0x17AA8){$("\x23\x74\x65\x73\x74\x2D\x63\x6F\x6E\x6E\x65\x63\x74").html(_0x17AA8)}})}
    ...
    <div class="sl-pagebody">
                    ...
                    <form action="index.php?Mikbotam=Settings" autocomplete="off" method="post" name="settings">
                                    ...
                                    <div class="card-body pd-sm-15">
                                        <div class="row">
                                           ...
                                           <div class="row mg-t-8">
                                            ...
                                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                <input id="portapi" type="text" class="form-control" name="port" placeholder="Port MikroTik" value="<?=$mikrotik_port;?>">
                                            </div>
                                        </div>
                                        <div class="row mg-t-8">
                                ...
                                <div class="card bd-primary">
                                    ...
                                    <div class="card-body pd-sm-15">
                                        ...
                                        <div class="row mg-t-10">
                                            <label class="col-sm-4 form-control-label">Nama Bot </label>
                                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                <input type="text" class="form-control" name="namabot" placeholder="Nama Bot" value="<?=$namabot;?>">
                                            </div>
                                        </div>

			...
			<div class="col-sm-6 col-xl-3 mg-t-10 mg-sm-t-0">
				<div class="card pd-20 pd-sm-10 boxed">
					<div class="d-flex align-items-center">
						...
						<div class="mg-l-10">
							<span class="tx-15 tx-spacing-1 tx-gray-500">
								Total Deposit</br> bulan ini<br><br>       </span>
			...
			<div class="col-sm-6 col-xl-3 mg-t-10 mg-xl-t-0">
				<div class="card pd-15 pd-sm-10 boxed">
					<div class="d-flex align-items-center">
						...
						<div class="mg-l-10">
							<span class="tx-15 tx-spacing-1 tx-gray-500">
								Total Pendapatan</br> bulan ini<br><br>  </span>
			...
			<div class="col-sm-6 col-xl-3 mg-t-10 mg-xl-t-0">
				<div class="card pd-20 pd-sm-10 boxed">
					<div class="d-flex align-items-center">
						...
						<div class="mg-l-10">
							<span class="tx-15 tx-spacing-1 tx-gray-500">
								Total User </br> bulan ini<br><br>       </span>
						...
						<div class="table-wrapper">
							<table id="userhistory" class="table display  nowrap " width="100%">
								...
								<tbody>
									...
									for ($i = 0; $i < $TotalReg; $i++) {
										...
										if ($keterangan == 'Success') {
											$ket = "<span class='label label-success m-r-15 text-uppercase'>SUKSES $exp_voucher</span>";
										} elseif ($keterangan == 'gagalprint') {
											$ket = "<span class='label label-warning m-r-15 text-uppercase'>GAGAL PRINT </span>";
										} elseif ($keterangan == 'gagal') {
											$ket = "<span class='label label-warning m-r-15 text-uppercase'>SERVER GANGGUAN</span>";
										} else {
											$ket = "<span class='label label-info m-r-15 text-uppercase'>DEPOSIT ".rupiah($top_up)." </span>";
											$beli_voucher = $top_up;
										}
										$Waktu = $datas['Waktu'];
								...
								//		echo "<td>" . $id_user . "</td>";
										...
										echo "<td>" . $ket . "</td>";
                                        echo "<td>" . $prefix . "" . $username_voucher . "</td>";

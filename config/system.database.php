...
function clearhistoriuser($id) {
	...
	return $deletoperating;
}

function resetvouchernya($id) {
	global $mikbotamdata;
...
function lastlogin($ip, $user, $status) {
	...
	global $mikbotamdata;
//	$tanggalkiye = date('Y-m-d');
//	$jamkiye = time('H:i:s');
//	$dinakiye = $jamkiye & $tanggalkiye;
...
function upbot($id, $token, $usernamebot, $namabot, $namarouter, $ipmik, $usernamemik, $passmik, $port, $dns, $owner, $idowner) {
...
function inbot($id, $token, $usernamebot, $namabot, $namarouter, $ipmik, $usernamemik, $passmik, $port, $dns, $owner, $idowner) {
	global $mikbotamdata;
